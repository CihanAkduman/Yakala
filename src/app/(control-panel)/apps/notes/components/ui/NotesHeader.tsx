			...
			<div className="flex flex-auto flex-col py-4">
				...
				<div className="flex min-w-0 flex-auto flex-col sm:flex-row sm:items-center">
					<div className="flex flex-auto flex-col">
						<Typography className="text-3xl leading-none font-extrabold tracking-tight">Notlar</Typography>
						<Typography
							className="font-medium tracking-tight"
							color="text.secondary"
						>
							Düşüncelerinizi ve fikirlerinizi yakalayın ve düzenleyin
						</Typography>
					</div>
					<div className="mt-2 flex items-center gap-2 sm:mx-2 sm:mt-0">
						{isMobile && (
							<IconButton
								...
								aria-label="sol kenar çubuğunu aç"
						...
						<Tooltip title="Değişken Açıklama Boyutunu Değiştir">
							<IconButton
								className="border-divider border"
