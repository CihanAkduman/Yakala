					...
					>
						...
						<div className="flex h-12 justify-between px-4">
							<div className="flex items-center gap-1.5">
								...
								{/* LOOP Badge - Hata Tekrar Sayısı */}
								{card.errorRepeatCount > 0 && (
									<Tooltip title={`${card.errorRepeatCount} kez tekrarlandı`}>
										<span className="flex items-center gap-0.5">
											<FuseSvgIcon
												size={16}
												color="error"
											...
											<Typography color="error">{card.errorRepeatCount}</Typography>
										</span>
									</Tooltip>
								)}
								
								{/* Corpix Badge */}
								{card.corpixTrainingLink && (
									<Tooltip title="Corpix eğitimi mevcut">
										<FuseSvgIcon
											size={16}
											color="success"
										>
								...
								{/* QM Badge - Etki Seviyesi */}
								{card.impactLevel && card.impactLevel >= 4 && (
									<Tooltip title={`Etki Seviyesi: ${card.impactLevel}/5`}>
										<FuseSvgIcon
											size={16}
											color="warning"
										>
