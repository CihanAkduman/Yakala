  ...
  const behaviorPatterns: BehaviorPattern[] = [
    {
      ...
      suggestedActions: ['Proaktif iletişim kur', 'Tazminat seçenekleri sun', 'Üst düzey temsilci ata']
    },
    {
      type: 'purchase_intent',
      confidence: 67,
      description: 'Business class yükseltme ilgisi gösteriyor',
      suggestedActions: ['Özel indirim sun', 'Lounge erişimi ekle', 'Miles kazanım vurgula']
    }
  ];
