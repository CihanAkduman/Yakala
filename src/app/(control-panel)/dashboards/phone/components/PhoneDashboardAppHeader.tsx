...
function PhoneDashboardAppHeader() {
			...
			<div className="flex min-w-0 flex-auto flex-col gap-2 sm:flex-row sm:items-center">
				<div className="flex flex-auto items-center gap-2">
					...
					<div className="flex min-w-0 flex-col">
						<Typography className="truncate text-xl leading-7 font-semibold tracking-tight md:text-3xl md:leading-[1.375]">
							{isGuest ? 'Merhaba Misafir!' : `Tekrar hoş geldiniz, ${user?.displayName || user?.email}!`}
						</Typography>
						<div className="flex items-center gap-1">
							...
							>
								3 bekleyen çağrı ve 5 yeni müşteri talebi var
							</Typography>
						</div>
					</div>
				</div>
				<div className="flex items-center gap-2">
					<Button
						...
						variant="contained"
						color="primary"
						startIcon={<FuseSvgIcon>lucide:phone-call</FuseSvgIcon>}
					>
						Çağrı Başlat
					</Button>
					<Button
...
export default PhoneDashboardAppHeader;