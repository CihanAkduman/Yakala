...
function GenderWidget() {
	...
	const { data: widget } = useGetWidget<GenderWidgetType>('Cinsiyet');
	...
	return (
		<Paper className="flex flex-auto flex-col overflow-hidden rounded-xl p-4 shadow-sm">
			<div className="flex flex-col items-start justify-between sm:flex-row">
				<Typography className="truncate text-lg leading-6 font-medium tracking-tight">Cinsiyet</Typography>
				<div className="ml-2">
					<Chip
						size="small"
