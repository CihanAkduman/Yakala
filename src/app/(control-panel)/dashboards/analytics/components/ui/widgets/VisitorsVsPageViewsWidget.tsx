				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
					<div className="flex flex-col">
						<div className="flex items-center">
							<div className="text-secondary leading-5 font-medium">Genel Puan</div>
							<Tooltip title="Puan, Sayfa Görüntülemeleri ve Çağrılar arasındaki geçmiş oranı kullanılarak hesaplanır. En iyi puan 1000, en kötü puan 0'dır.">
								<FuseSvgIcon
									className="ml-1.5"
									size={16}
									color="disabled"
					...
					<div className="flex flex-col">
						<div className="flex items-center">
							<div className="text-secondary leading-5 font-medium">Ortalama Oran</div>
							<Tooltip title="Ortalama Oran, WebChat ile Çağrıların arasındaki ortalama orandır.">
								<FuseSvgIcon
									className="ml-1.5"
									size={16}
									color="disabled"
					...
					<div className="flex flex-col">
						<div className="flex items-center">
							<div className="text-secondary leading-5 font-medium">Tahmin Edilen Oran</div>
							<Tooltip title="Tahmin Edilen Oran, geçmiş oranlar, mevcut eğilimler ve hedefleriniz kullanılarak hesaplanır.">
								<FuseSvgIcon
									className="ml-1.5"
									size={16}
									color="disabled"
