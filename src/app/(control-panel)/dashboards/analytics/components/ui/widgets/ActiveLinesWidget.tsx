...
/**
 * Aktif hatlar widget'ı.
 */
function ActiveLinesWidget() {
	...
	return (
		<Paper className="flex flex-auto flex-col overflow-hidden rounded-xl shadow-sm">
			<div className="m-4 mb-0 flex items-start justify-between">
				<Typography className="truncate text-lg leading-6 font-medium tracking-tight">Aktif Hatlar</Typography>
				<div className="ml-2">
					<Chip
						size="small"
			...
			<div className="mx-4 mt-3 flex flex-col gap-3 lg:flex-row lg:items-center">
				...
				<div className="flex lg:flex-col">
					...
					>
						...
						<span className="ml-1">hedefin altında</span>
					</Typography>
				</div>
			</div>
...
export default ActiveLinesWidget;