...
import { ScrumboardMember } from '@/app/(control-panel)/apps/loop/api/types';

/**
 * GET api/mock/loop/members/{id}
 */
...
/**
 * DELETE api/mock/loop/members/{id}
 */
